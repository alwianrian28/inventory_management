 ...
 * @author Dearclaudia
 */
public class TabModBarangKeluarDetail extends AbstractTableModel {
    ...
    public TabModBarangKeluarDetail() {
    ...
    private final String[] columnNames = {"No","No Transaksi","Tanggal","Barcode","Nama Barang","Satuan","Jumlah","Harga Jual","Subtotal"};
