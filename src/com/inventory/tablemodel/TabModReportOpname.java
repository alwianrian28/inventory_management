 ...
 * @author Dearclaudia
 */
public class TabModReportOpname extends AbstractTableModel {
    ...
    private final String[] columnNames = {"No","Tanggal","Keterangan","Status","Nama Barang","Stok Sistem","Stok Fisik","Selisih","Catatan"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return model.getStokOpname().getKeterangan();
            case 3:
                return model.getStokOpname().getStatus();
            case 4:
