...
public class ColumnDeleteOpnameTmp {
    ...
    public static class ButtonEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (row >= 0) { 
                TabModOpnameTmp model = (TabModOpnameTmp) table.getModel();
                StokOpnameTmp modelTmp = model.getData(row);
                
                StokOpnameTmpController controller = new StokOpnameTmpController();
                controller.deleteData(modelTmp.getOpnameTmpID());
