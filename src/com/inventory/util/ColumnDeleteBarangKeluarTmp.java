...
public class ColumnDeleteBarangKeluarTmp {
    ...
    public static class ButtonEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (row >= 0) { 
                TabModBarangKeluarTmp model = (TabModBarangKeluarTmp) table.getModel();
                BarangKeluarTmp modelTmp = model.getData(row);
                
                BarangKeluarTmpController controller = new BarangKeluarTmpController();
                controller.deleteData(modelTmp.getBarangKeluarTmpID());
