...
import com.inventory.tablemodel.TabModBarangMasukDetail;
 ...
 * @author Dearclaudia
 */
public class DataBarangMasukDetail extends JDialog{

    private JPanel overlay;
    
    private final BarangMasukDetailController controller = new BarangMasukDetailController();
    private final TabModBarangMasukDetail tblModel = new TabModBarangMasukDetail();
    ...
    public DataBarangMasukDetail(Frame parent, String title, boolean modal, BarangMasuk barangMasuk) {
    ...
    private void updateTable(boolean isSearch) {
        ...
        int totalItems = controller.getTotalItems(barangMasuk.getBarangMasukID(),keyword);
        pagination.setTotalItems(totalItems);

        List<BarangMasukDetail> list;
        if (isSearch) {
            list = controller.searchDataById(barangMasuk.getBarangMasukID(), keyword, pagination.getItemsPerPage(), pagination.getCurrentPage());
        } else {
            list = controller.getDataById(barangMasuk.getBarangMasukID(), pagination.getItemsPerPage(), pagination.getCurrentPage());
        }
