...
import com.inventory.tablemodel.TabModBarangKeluarDetail;
 ...
 * @author Dearclaudia
 */
public class DataBarangKeluarDetail extends JDialog{

    private JPanel overlay;
    
    private final BarangKeluarDetailController controller = new BarangKeluarDetailController();
    private final TabModBarangKeluarDetail tblModel = new TabModBarangKeluarDetail();
    ...
    public DataBarangKeluarDetail(Frame parent, String title, boolean modal, BarangKeluar barangKeluar) {
    ...
    private void updateTable(boolean isSearch) {
        ...
        int totalItems = controller.getTotalItems(barangKeluar.getBarangKeluarID(),keyword);
        pagination.setTotalItems(totalItems);

        List<BarangKeluarDetail> list;
        if (isSearch) {
            list = controller.searchDataById(barangKeluar.getBarangKeluarID(), keyword, pagination.getItemsPerPage(), pagination.getCurrentPage());
        } else {
            list = controller.getDataById(barangKeluar.getBarangKeluarID(), pagination.getItemsPerPage(), pagination.getCurrentPage());
        }
