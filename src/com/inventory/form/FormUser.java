...
import com.inventory.form.input.FormInputUser;
...
import com.inventory.tablemodel.TabModUser;
...
public class FormUser extends Form{
    ...
    private JPanel setInfo() {
        ...
        JLabel lbBreadcrumb = new JLabel("OTHER > Manajemen User > User");
    ...
    private JPanel setButton() {
        ...
        cbxStatus.addActionListener(e -> {
            handleStatusChange(btnRestore, btnAdd, btnUpdate, btnDelete);
        });        
    ...
    private void handleStatusChange(JButton btnRestore, JButton btnAdd, JButton btnUpdate, JButton btnDelete) {
    ...
    private void insertData() {
        ...
        ModalDialog.showModal(this, 
                new SimpleModalBorder(new FormInputUser(null, this),"Tambah User"), option,"form input");
    }
    ...
    private void updateData() {
        ...
        if(row != -1){
            ...
            option.setBackground(Color.BLACK);
            ModalDialog.showModal(this, 
                    new SimpleModalBorder(new FormInputUser(model, this),"Perbarui User"), option,"form update");
        }else{
            ...
            ModalDialog.showModal(this, new MessageModal(MessageModal.Type.INFO, message, title, ModalBorder.YES_NO_OPTION, 
                (control, action) -> {
                    if (action == ModalBorder.YES_OPTION) {
                        boolean success = controller.restoreData(model.getUserID(), model.getUsername());
