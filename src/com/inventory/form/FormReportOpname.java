...
import com.inventory.tablemodel.TabModReportOpname;
...
public class FormReportOpname extends Form{
    private static final long serialVersionUID = 1L;


    private final ReportController controller = new ReportController();
    private final TabModReportOpname tblModel = new TabModReportOpname();
    ...
    private DatePicker pickerOpnameDate;
    private JFormattedTextField txtOpnameDate;
    
    private Date startDate;
    private Date endDate;
    
    public FormReportOpname() {
    ...
    private JPanel setInfo() {
        ...
        JLabel lbTitle = new JLabel("Data Laporan Stok Opname Barang");
        lbTitle.putClientProperty(FlatClientProperties.STYLE, "font:bold 17");
        
        JLabel lbBreadcrumb = new JLabel("LAPORAN > Laporan Stok Opname");
    ...
    private JPanel setButton() {
        ...
        pickerOpnameDate = new DatePicker();
        pickerOpnameDate.setDateSelectionMode(DatePicker.DateSelectionMode.BETWEEN_DATE_SELECTED);
        pickerOpnameDate.setUsePanelOption(true);
        pickerOpnameDate.setCloseAfterSelected(true);
        txtOpnameDate = new JFormattedTextField();
        txtOpnameDate.setHorizontalAlignment(JFormattedTextField.CENTER);
        pickerOpnameDate.setEditor(txtOpnameDate);
        ...
        btnPreview.addActionListener((e) -> {
            controller.exportOpname(startDate,endDate,ExportType.PREVIEW);
        });
        ...
        btnPDF.addActionListener((e) -> {
            controller.exportOpname(startDate,endDate,ExportType.PDF);
        });
        ...
        btnExcel.addActionListener((e) -> {
            controller.exportOpname(startDate,endDate,ExportType.EXCEL);
        });
        ...
        panel.add(txtOpnameDate,"hmin 30, wmin 200");
    ...
    private boolean hasValidDateSelection() {
        LocalDate[] dates = pickerOpnameDate.getSelectedDateRange();
    ...
    private void updateTable(boolean isSearch) {
        ...
        int totalItems = controller.getTotalItemsOpname(startDate, endDate, keyword);
        pagination.setTotalItems(totalItems);

        List<StokOpnameDetail> list = controller.getDataOpname(startDate, endDate, keyword, pagination.getItemsPerPage(), pagination.getCurrentPage());
    ...
    private void resetDate(){
        disableComponent();
        pickerOpnameDate.clearSelectedDate();
        txtOpnameDate.setValue(null);
        tblModel.clear();
        pagination.firstPage();
    }
