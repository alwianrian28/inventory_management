...
import com.inventory.tablemodel.TabModStokGudang;
 ...
 * @author Dearclaudia
 */
public class FormStokGudang extends Form{

    private final StokGudangController controller = new StokGudangController();
    private final TabModStokGudang tblModel = new TabModStokGudang();
    ...
    private JPanel setInfo() {
        ...
        JLabel lbTItle = new JLabel("Data Stok Gudang");
        lbTItle.putClientProperty(FlatClientProperties.STYLE, "font:bold 17");
        
        JLabel lbBreadcrumb = new JLabel("MASTER > Stok Gudang");
    ...
    private void setTableProperties() {
        TabelUtils.setColumnWidths(tblData, new int[]{0,1}, new int[]{50,300});
